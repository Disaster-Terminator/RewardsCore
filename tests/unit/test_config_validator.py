...
class TestConfigValidator:
    ...
    def test_validate_field_types_and_ranges_allowed_values(self, validator):
        ...
        config = {
            "search": {},
            "browser": {"prevent_focus": "invalid_value"},
            "account": {}
        }
    ...
    def test_validate_logical_consistency_search_counts(self, validator):
        """测试逻辑一致性验证 - 搜索次数"""
        config = {
            "search": {"desktop_count": 40, "mobile_count": 30},
            "browser": {},
            "account": {}
        }
    ...
    def test_validate_file_paths_missing_file(self, mock_exists, validator):
        ...
        config = {
            "search": {"search_terms_file": "nonexistent.txt"},
            "browser": {},
            "account": {}
        }
    ...
    def test_validate_file_paths_create_log_dir(self, mock_dirname, mock_exists, mock_makedirs, validator):
        """测试文件路径验证 - 创建日志目录"""
